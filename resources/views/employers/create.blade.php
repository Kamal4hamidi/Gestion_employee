...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Ajouter Employer</h3>
            <div class="section-intro">AJouter ici des nouvelles employers</div>
        </div>
                    ...
                    <form class="settings-form" method="POST" action="{{ route('employer.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="departement_id" id="departement_id" class="form-control">
                                ...
                                @foreach ($departementsList as $departement)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                                placeholder="Entrer le numero telephone" name="phone_employer">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3"
                                placeholder="Entrer le Montant Journalier" value="montant_journalier" name="montant_journalier">
                            @error('montant_journalier')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

                        <button type="submit" class="btn app-btn-primary">Ajouter Employer</button>
                    </form>
                </div><!--//app-card-body-->
