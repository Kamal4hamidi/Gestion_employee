...
class SendEmailToAdminAfterRegistrationNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Bonjour')
            ->line('Votre compte a été crée avec succès sur la plateforme de gestion de salaire et d\'employer et Saisissez le code ' . $this->code . ' et renseigner le dans le formulaire qui appraitra lorsque vous cliquerez sur le bouton ci dessous')
            ->line('pour valider votre compte')
