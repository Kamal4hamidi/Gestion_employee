                            ...
                            <tbody>
                                ...
                                @forelse ($departements as $departement)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary bg-success text-white" href="{{route('departement.edit',$departement->id)}}">Editer</a>
                                            <a class="btn-sm app-btn-secondary bg-danger text-white" href="{{route('departement.delete',$departement->id)}}">Retirer</a>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="cell" colspan="6">Aucune departement existe</td>
                                    </tr>
                                @endforelse
