                    ...
                    <form class="settings-form" method="POST" action="{{ route('departement.update',$departement) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1"
                                placeholder="Entrer le nom du departement" name="nom_departement" value="{{$departement->name}}" required>
                            <div style="color:red;">
                        ...
                        <button type="submit" class="btn app-btn-primary">Mettre a jour departement</button>
                    </form>
