    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="assets/images/app-logo.svg"
                    alt="logo"><span class="logo-text">{{AppNameGetter::getAppName() ? AppNameGetter::getAppName() : 'E-Salaire'}}</span></a>
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link submenu-toggle" href="#s" data-bs-toggle="collapse"
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" 
                                    ...
                                    Employers</a></li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('employer.create') }}">Ajouter
                                    Employer</a>
                            </li>
                            {{-- <li class="submenu-item"><a class="submenu-link"
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" 
                                    href="{{ route('departement.index') }}">List
                                    Departement</a></li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('departement.create') }}">Ajouter
                                    Departement</a>
                            </li>
                            {{-- <li class="submenu-item"><a class="submenu-link"
                                    href="settings.html">Settings</a>
                ...
                </li><!--//nav-item pour les deppartements-->
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link submenu-toggle" href="#s" data-bs-toggle="collapse"
                    ...
                    <div id="submenu-5" class="collapse submenu submenu-5" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" 
                                    href="{{ route('admin.index') }}">List
                                    Admin</a></li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('admin.create') }}">Ajouter
                                    Admin</a>
                            </li>
                            {{-- <li class="submenu-item"><a class="submenu-link"
                                    href="settings.html">Settings</a>
