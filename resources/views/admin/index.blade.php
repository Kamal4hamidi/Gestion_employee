...
@section('content')
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Administarateurs</h1>
        </div>
        <div class="col-auto">
    ...
    <div class="tab-content" id="orders-table-tab-content">
        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
            <div class="app-card app-card-orders-table shadow-sm mb-5">
                <div class="app-card-body">                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @forelse ($admins as $admin)
                                    <tr>
                                        ...
                                        {{-- <td class="cell"><span class="badge bg-success">valide</span></td> --}}
                                        <td class="cell"><span class="badge bg-warning">St Pending</span></td>
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary bg-success text-white"
                                                href="{{ route('admin.edit', $admin->id) }}">Editer</a>
                                            <a class="btn-sm app-btn-secondary bg-danger text-white"
                                                href="{{ route('admin.delete', $admin->id) }}">Retirer</a>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="cell" colspan="6">Aucune Admin existe</td>
                                    </tr>
                                @endforelse
