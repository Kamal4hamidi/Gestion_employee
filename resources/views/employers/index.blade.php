...
@section('content')
    ...
    {{-- <div class="alert alert-success" role="alert">
        adding new user successfully done 
    </div> --}}
                            ...
                            <tbody>
                                ...
                                @forelse ($employers as $employer)
                                    ...
                                    <tr>
                                        ...
                                        <td class="cell"><span class="">{{$employer->email}}</span></td>
                                        <td class="cell"><span class="">{{$employer->contact}}</span></td> 
                                        <td class="cell"><span class="badge bg-success">paid</span></td> 
                                        
                                        <td class="cell"><a class="btn-sm app-btn-secondary" href="#">{{$employer->montant_journalier}} Dh</a></td>
                                        <td class="cell">
                                            <a class="btn-sm app-btn-secondary bg-success text-white" href="{{route('employer.edit',$employer->id)}}">Editer</a>
                                            <a class="btn-sm app-btn-secondary bg-danger text-white" href="{{route('employer.delete',$employer->id)}}">Retirer</a>
                                        </td>   
                                    </tr>
                                    @empty
                                    <tr>
                                        <td class="cell" colspan="6">Aucune employer existe</td>
                                    </tr>
                                @endforelse
