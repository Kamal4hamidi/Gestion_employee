...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Mis a jour Employer</h3>
            <div class="section-intro">Mis a jour employers</div>
        </div>
                    ...
                    <form class="settings-form" method="POST" action="{{ route('employer.update',$employer->id) }}">
                            ...
                            <select name="departement_id" id="departement_id" class="form-control">
                                ...
                                @foreach ($departements as $departement)
                                    <option value="{{ $departement->id }}"
                                        {{ $employer->departements_id === $departement->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le nom "
                                name="nom_employer" value="{{$employer->nom}}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2" placeholder="Entrer le prenom"
                                name="prenom_employer" value="{{$employer->prenom}}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer l'email"
                                name="email_employer"value="{{$employer->email}}">
                            @error('email_employer')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                                placeholder="Entrer le numero telephone" name="phone_employer" value="{{$employer->contact}}">
                            @error('phone_employer')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3"
                                placeholder="Entrer le Montant Journalier" value="montant_journalier" name="montant_journalier" value="{{ $employer->montant_journalier }}">
                            @error('montant_journalier')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

                        <button type="submit" class="btn app-btn-primary">MAJ Employer</button>
                    </form>
                </div><!--//app-card-body-->
