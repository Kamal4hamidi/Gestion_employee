...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Ajouter departement</h3>
            <div class="section-intro">Ajouter ici des nouvelles departements</div>
        </div>
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('departement.store') }}">
                        ...
                        <div class="mb-3">
                            <label for="setting-input-1" class="form-label">Nom departement<span class="ms-2"
                            ...
                            <input type="text" class="form-control" id="setting-input-1"
                                placeholder="Entrer le nom du departement" name="nom_departement" value="{{old('nom_departement')}}" required>
                            <div style="color:red;">
                        ...
                        <button type="submit" class="btn app-btn-primary">Ajouter departement</button>
                    </form>
